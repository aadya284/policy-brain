...
import { QueryRequest, QueryResponse, PineconeMatch } from '../types/index.js';
...
export class GroqService {
   ...
   */
  async generateAnswer(query: string, context: PineconeMatch[]): Promise<QueryResponse> {
    try {
...
Answer:`;
   ...
   */
  private calculateConfidence(context: PineconeMatch[]): number {
   ...
   */
  async generateSummary(query: string, context: PineconeMatch[]): Promise<string> {
    try {
